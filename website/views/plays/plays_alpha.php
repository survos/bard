<?php 
// page title 
$title = "Alphabetical list of Shakespeare's plays"; 
...
?> 
      ...
      <table align="center" cellpadding='10'>
        <tr> 
    <td colspan='3'> 
 		<h1>Shakespeare's plays,<br>listed alphabetically</h1>
...
while($currentrow = mysqli_fetch_array($queryexe)) {
   ...
   $playactive = 1;
   // start the item
   print("   <li class='playtext'>");
   // if the play is active, insert a link to it
   if ($playactive) {
      print("<a href='playmenu.php?WorkID=$playid'>");
   }
   // show the title regardless
   print("<strong>$playtitle</strong>");
   // end the the link if necessary
   if ($playactive) {
      print("</a>");
   }
   // show the play's date
   print(" <em>($playdate)</em>");
}
?>
</td></tr></table>
		
<p align="center" class='normalsans' style='font-size:14px; font-weight=bold;'> 
  List plays <a href="plays.php">by genre</a> <img src="../../images/small_dingbat.gif" alt="+" width="7" height="9" border="0" align="middle"> 
  <a href="plays_date.php">by date</a> <img src="../../images/small_dingbat.gif" alt="+" width="7" height="9" border="0" align="middle"> 
